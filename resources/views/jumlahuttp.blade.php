@extends('layouts.jumlahuttplayouts')

@section('jumlahuttp')
<div class="container px-5 py-24 mx-auto">
    <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        Jumlah Potensi UTTP
        <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Berikut ini adalah Tabel Jumlah Alat - Alat Ukur, Takar, Timbang dan Perlengkapannya berdasarkan Kecamatan di Kabupaten Muna Barat.</p>
    </caption>
